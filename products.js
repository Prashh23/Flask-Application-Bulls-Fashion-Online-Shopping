...
if(localStorage.getItem("cart")){
 ...
 for(var product of products){
                ...
                <div class="featured-data">
                    ...
                    <small align="left"><small style="font-weight: 700;">Description:</small>`+product.desc+`</small>
                    <div class="product-price"><small style="font-weight: 700;">Price:</small>`+product.price+`</div>
                </br>
             
                <button class="btn btn-primary" id="shop" onclick="addToCart('`+product.id+`')">Add</button>
                </div>
            </div>`)
}
productsInCart=localStorage.getItem("productsInCart")
